...
local function reg()
    local opt = {fn = function() end, name = "xx", aliass = {}, keys = {}}
    -- TODO
end
local function call()
    -- TODO
...
gen_actions = function()
    return {
        action_list_all_actions(), a_find_file_in_project(),
        a_delete_current_file(), a_toggle_side(), a_format(), a_sync_package(),
